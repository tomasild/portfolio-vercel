...
export function ExpAndProjects() {
  ...
  return (
    <div className="flex flex-col w-full h-full pt-2">
      <h2 className="text-center font-semibold text-[1.6rem] mx-2">
            ...
            >
              <div className="overflow-hidden">
                <div className="pt-1 flex items-center justify-center space-x-2">
                  <h3 className="text-[1.2rem] font-semibold text-center tracking-wide hover:text-primary">
                    {project.title}
                  </h3>
                ...
                ></CardContent>
                <p className="text-[1rem] text-pretty font-normal dark:font-normal dark:text-gray-200 text-black pb-4">
                  {project.preview}
                </p>
              </div>
            </CarouselItem>
